...
public class GraphView extends SurfaceView {
    ...
    /**
     * Methode for adding node on the graph
     *
    ...
    /**
     * Methode for removing selected node from the graph
     */
    ...
    /**
     * Methode for adding text on the selected node
     *
     * @param text text, that displayed on the node
     */
    ...
    /**
     * Methode for link selected nodes. It add link on graph between nodes
     */
    ...
    /**
     * Methode for link nodes, that had got index. Use it for link nodes when read database
     *
    ...
    /**
     * Methode for get number of link in link array after link was clicked
     *
    ...
    /**
     * Methode for get number of node in node array after node was clicked
     *
     * @param x is x coordinate
     * @param y is y coordinate
    ...
    /**
     * Methode for selecting and moving the node, that we clicked
     *
